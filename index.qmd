...
![](images/logo_ala.png){.absolute bottom=50px left=10 width=200px} ![](images/logo_tern.png){.absolute bottom=50px left=220 width=200px} ![](images/logo_imos.png){.absolute bottom=50px left=430 width=200px} ![](images/logo_ardc.png){.absolute bottom=50px left=640 width=200px} ![](images/logo_ncris.png){.absolute bottom=50px left=850 width=200px} ![](images/logo_austgov.png){.absolute bottom=50px left=1060 width=200px}
